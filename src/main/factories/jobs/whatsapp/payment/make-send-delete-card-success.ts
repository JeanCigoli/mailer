import { HttpSendDeleteCardSuccess } from '../../../../../data/usecases/whatsapp';
...
export const makeSendDeleteCardSuccess = () => {
  ...
  const httpListCardsDeletesDefault = new HttpSendDeleteCardSuccess(
    sendMessageHttp,
  ...
  return new SendDeleteCardSuccessJob(httpListCardsDeletesDefault);
};
