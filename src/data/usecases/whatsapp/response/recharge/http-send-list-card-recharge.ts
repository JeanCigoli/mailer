...
export class HttpSendListCardRecharge implements SendListCardRecharge {
  constructor(
  ...
  async send(params: SendListCardRecharge.Params): SendListCardRecharge.Result {
    const destinations = [
      {
            ...
            sections: [
              {
                rows: [
                  ...
                  {
                    identifier: 3,
                    description: 'Adicionar outro cartão para utilização',
                    title: 'Novo cartão',
                  },
                  {
                    identifier: 0,
